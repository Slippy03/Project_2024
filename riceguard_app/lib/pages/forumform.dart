                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF2E7D32).withOpacity(0.1), Color(0xFF2E7D32).withOpacity(0.05)],
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.location_on, color: Color(0xFF2E7D32), size: 24),
                      ),
                      SizedBox(width: 12),
                      Expanded(
                        child: Column(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        _selectedImage == null ? "เพิ่มรูปภาพ" : "เปลี่ยนรูปภาพ",
                        style: TextStyle(fontWeight: FontWeight.w600),
                      ),
                      style: OutlinedButton.styleFrom(
                        foregroundColor: Color(0xFF2E7D32),
                        side: BorderSide(color: Color(0xFF2E7D32).withOpacity(0.5), width: 1.5),
